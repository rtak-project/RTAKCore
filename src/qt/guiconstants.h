...
/* RTAK GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "RTAK"
#define QAPP_ORG_DOMAIN "rtak.org"
#define QAPP_APP_NAME_DEFAULT "RTAK-Qt"
#define QAPP_APP_NAME_TESTNET "RTAK-Qt-testnet"
