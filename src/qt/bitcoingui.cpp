                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("RTAK Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a RTAK address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and rtak: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for RTAK"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About RTAK Core"), this);
    aboutAction->setStatusTip(tr("Show information about RTAK Core"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(QIcon(":/qt-project.org/qmessagebox/images/qtlogo-64.png"), tr("About &Qt"), this);
    aboutQtAction->setStatusTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setStatusTip(tr("Modify configuration options for RTAK"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your RTAK addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified RTAK addresses"));
    ...
    openAction->setStatusTip(tr("Open a RTAK: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the RTAK Core help message to get a list with possible RTAK command-line options"));
...
//        toolbar->widgetForAction(spacer)->setObjectName("ToolbarSpacer");
        ...
        */
        ...
        labelTopLogo->setStyleSheet("background: url(:/images/rtak_logo_horizontal) cover no-repeat;\nborder-radius: 0px; background-position: left;\npadding: 25px;\nbackground-color: #fff;");
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("RTAK Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to RTAK network", "", count));
}
...
{
    QString strTitle = tr("RTAK Core"); // default title
