                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strRTAKPathCustom = GetArg("-mdsbackuppath", "");
    ...
    if(!strRTAKPathCustom.empty()) {
        ui->wallet_custommdsbackuppath->setText(QString::fromStdString(strRTAKPathCustom));
        ui->wallet_custommdsbackuppath_label->setVisible(true);
        ui->wallet_custommdsbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strRTAKPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the RTAK RPC console.") + "<br>" +
