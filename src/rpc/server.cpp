...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* RTAK features */
        {"rtak", "masternode", &masternode, true, true, false},
        {"rtak", "listmasternodes", &listmasternodes, true, true, false},
        {"rtak", "getmasternodecount", &getmasternodecount, true, true, false},
        {"rtak", "masternodeconnect", &masternodeconnect, true, true, false},
        {"rtak", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"rtak", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"rtak", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"rtak", "masternodecurrent", &masternodecurrent, true, true, false},
        {"rtak", "masternodedebug", &masternodedebug, true, true, false},
        {"rtak", "startmasternode", &startmasternode, true, true, false},
        {"rtak", "createmasternodekey", &createmasternodekey, true, true, false},
        {"rtak", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"rtak", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"rtak", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"rtak", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"rtak", "getmasternodescores", &getmasternodescores, true, true, false},
        {"rtak", "mnbudget", &mnbudget, true, true, false},
        {"rtak", "preparebudget", &preparebudget, true, true, false},
        {"rtak", "submitbudget", &submitbudget, true, true, false},
        {"rtak", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"rtak", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"rtak", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"rtak", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"rtak", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"rtak", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"rtak", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"rtak", "checkbudgets", &checkbudgets, true, true, false},
        {"rtak", "mnsync", &mnsync, true, true, false},
        {"rtak", "spork", &spork, true, true, false},
        {"rtak", "getpoolinfo", &getpoolinfo, true, true, false},
...
{
    return "> rtak-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:22366/\n";
}
