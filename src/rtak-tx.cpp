...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("RTAK Core rtak-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  rtak-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded rtak transaction") + "\n" +
                               "  rtak-tx [options] -create [commands]   " + _("Create hex-encoded rtak transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded rtak transaction
