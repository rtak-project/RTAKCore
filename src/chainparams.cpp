...
public:
    CMainParams()
    {
        ...
        vAlertPubKey = ParseHex("046719f753770014f3b24224c1808a103ea87e15a3c15c14cb4a594e56afd82f4a30847eab946cb88f1086eb34c48f25ea5f1dba193fbd1125c7796aaae26d4339");
        nDefaultPort = 50555;
        bnProofOfWorkLimit = ~uint256(0) >> 20; // RTAK starting difficulty is 1 / 2^12
        ...
        nRejectOldSporkKey = 1504709800; //!> Fully reject old spork key after (GMT): Friday, June 1, 2018 12:00:00 AM
        ...
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("04dab46bbbc68866455cc33b7ff7f22d5f0ee1c69f4bffe51bd21ad6db8f5a155a1eab72576b7ff6f943e7ec97a86d83083fed1896d57a913261f2ad56ac71f7c5") << OP_CHECKSIG;
        genesis.vtx.push_back(txNew);
        genesis.hashPrevBlock = 0;
        genesis.hashMerkleRoot = genesis.BuildMerkleTree();
        genesis.nVersion = 1;
        genesis.nTime = 1544709800;
        ...
        strSporkKey = "0458185156084ca3e1736023897732b564d1264a16fa3256c606c14217da471b5c3a11004ad888fa8b6b526003a86513b970c14579876066c5e44ffddcca62c7c4";
        strSporkKeyOld = "0458185156084ca3e1736023897732b564d1264a16fa3256c606c14217da471b5c3a11004ad888fa8b6b526003a86513b970c14579876066c5e44ffddcca62c7c4";
        strObfuscationPoolDummyAddress = "D87q2gC9j6nNrnzCsg4aY6bHMLsT9nUhEw";
        nStartMasternodePayments = 1547370000; //Wed, 25 Jun 2014 20:36:16 GMT
...
public:
    CTestNetParams()
    {
        ...
        vAlertPubKey = ParseHex("04b4f0e01bd46e130dc4e62751c6c7ea540e6caa3fed917761ae9c7eecae69c161031ae7002418b60d0a7870975406082eeede556b86b50e77a9a0dffe7b86a1ba");
        nDefaultPort = 50444;
        nEnforceBlockUpgradeMajority = 51;
        nRejectBlockOutdatedMajority = 75;
        nToCheckBlockUpgradeMajority = 100;
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // RTAK: 1 day
        nTargetSpacing = 2 * 60;  // RTAK: 1 minute
        nLastPOWBlock = 300;
        nMaturity = 15;
        ...
        strSporkKey = "04cd5fb87138da13db85f95c28b5a905b94422bfb680528d26f621e80ed188ef5a1cb92899f2063627a2e003d0302995863ea23788b88a65bb708d7c442ec33572";
        strSporkKeyOld = "04cd5fb87138da13db85f95c28b5a905b94422bfb680528d26f621e80ed188ef5a1cb92899f2063627a2e003d0302995863ea23788b88a65bb708d7c442ec33572";
        strObfuscationPoolDummyAddress = "y57cqfGRkekRyDRNeJiLtYVEbvhXrNbmox";
        nStartMasternodePayments = 1544686370; //Fri, 09 Jan 2015 21:05:58 GMT
