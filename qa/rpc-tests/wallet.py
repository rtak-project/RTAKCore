...
#   c) node1 mines 32 blocks, so now node 0 has 60001mds, node 1 has 4250mds, node2 has none.
#   d) node0 sends 601 mds to node2, in two transactions (301 mds, then 300 mds).
