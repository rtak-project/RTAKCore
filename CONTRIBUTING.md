Contributing to RTAK Core
============================

The RTAK Core project operates an open contributor model where anyone is
...
The following applies to code changes to the RTAK Core project, and is not to be
confused with overall RTAK Network Protocol consensus changes.

Whether a pull request is merged into RTAK Core rests with the project merge
...
Patches that change RTAK consensus rules are considerably more involved than
...
Where a patch set proposes to change the RTAK consensus, it must have been
...
The project leader is the release manager for each RTAK Core release.
