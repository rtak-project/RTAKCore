...
In order to support loading of multiple wallets in rtak-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is rtak.cpp.
...
Changes to rtak.cpp
----------------------
rtak.cpp is the entry point into rtak-qt, and as such, will require some minor modifications to provide hooks for
