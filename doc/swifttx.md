...
This mechanism has been integrated into Bitcore-Node-RTAK which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/RTAK-Project/insight-api-rtak#web-socket-api](https://github.com/RTAK-Project/insight-api-rtak#web-socket-api) 
* API: [https://github.com/RTAK-Project/insight-api-rtak#swifttx-transactions](https://github.com/RTAK-Project/insight-api-rtak#swifttx-transactions) 
...
By default, the RTAK Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the RTAK Core daemon:
