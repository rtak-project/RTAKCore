...
RESOURCES += src/qt/rtak.qrc src/qt/rtak_locale.qrc

TRANSLATIONS += src/qt/locale/rtak_bg.ts \
                src/qt/locale/rtak_de.ts \
                src/qt/locale/rtak_en.ts \
                src/qt/locale/rtak_es.ts \
                src/qt/locale/rtak_fi.ts \
                src/qt/locale/rtak_fr.ts \
                src/qt/locale/rtak_it.ts \
                src/qt/locale/rtak_ja.ts \
                src/qt/locale/rtak_pl.ts \
                src/qt/locale/rtak_pt.ts \
                src/qt/locale/rtak_ru.ts \
                src/qt/locale/rtak_sk.ts \
                src/qt/locale/rtak_sv.ts \
                src/qt/locale/rtak_vi.ts \
                src/qt/locale/rtak_zh_CN.ts \
                src/qt/locale/rtak_zh_TW.ts
